...
<div class="header">
    ...
    <h3 class="arrow" style="left: 660px;">WELCOME&nbsp; SUPERVISOR!</h3>

    <b style="position: absolute; top: 10px; right: 150px;">SUPERVISOR</b>
...
<div class="center-box">
    <form class="akhil" action="MaintenanceServlet" method="POST">
        <h2 style="margin-left:110px; margin-bottom:40px;">Add Maintenance Details</h2>
           ...
           <!-- 
            ...
            <%
                ...
                try {
                    ...
                    String flatQuery = "SELECT FlatID, BuildingName FROM ResidentDetails ORDER BY BuildingName, FlatID";
        ...
        <input class="funk" type="text" name="Amount" id="amountInput"style="margin-left:100px;" required><br>
           <span id="amountError" style="color: red;"></span><br>
 ...
 <script> 
        ...
        document.getElementById("amountInput").addEventListener("input", function() {
            ...
            if (!isValidAmount(amount)) {
                document.getElementById("amountError").textContent = "Please enter a valid amount (number with decimals).";
            } else {
        ...
        function isValidAmount(amount) {
            // Use a regular expression to check if it's a valid number with decimals
            var regex = /^[0-9]+(\.[0-9]+)?$/;
