...
<body>
   ...
   <%
        ...
        try {
            ...
            String sql = "SELECT * FROM MaintenanceRecords order by BuildingName,FlatID";
    ...
    <table>
        ...
        <%
            while (resultSet.next()) {
            	 String role = resultSet.getString("BuildingName");
                int Name = resultSet.getInt("FlatID");
                String Amount = resultSet.getString("Amount");
                String phone = resultSet.getString("PaymentStatus");
                String Date = resultSet.getString("PaymentDate");
                String mode = resultSet.getString("Paymentmode");
        %>
        <tr>
            <td><%= role %></td>
            <td><%= Name %></td>
