...
<div class="header">
    ...
    <form class="akhil" action="UpdateUsernameServlet" method="post">
    <h2  style="margin-left: 105px;">UPDATE Password DETAILS </h2> <br><br>
        <label for="currentUsername" style="font-size: 16px;">Current Password:</label>
        <input class="funk" type="text" id="currentUsername" style="margin-left: 25px;"name="currentUsername" value="<%= session.getAttribute("password") %>" disabled>

        <label for="newUsername" style="font-size: 16px;">New Password:</label>
