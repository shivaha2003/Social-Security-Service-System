...
<div class="center-box">
    ...
    <form class="akhil"action="AddRegularDetailsServlet" method="POST">
        
            <h2  style="margin-left: 105px;">ADD-Regular Visitor DETAILS </h2> <br><br>
           <label for="VisitorName" style="font-size: 16px;"><strong>&nbsp;&nbsp;&nbsp;Visitor Name : </strong></label>
