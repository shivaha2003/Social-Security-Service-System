...
<div class="center-box">
    <form class="akhil" action="AddnormalDetailsServlet" method="POST">
        <h2 style="margin-left:70px; margin-bottom:40px;">Add Normal Visitor Details</h2>
        <label for="FirstName">Guest Name:</label>
        <input class="funk" type="text" name="FirstName" style="margin-left:80px;" required><br>
        ...
        <input class="funk" type="text" name="relation" style="margin-left:110px;" required><br>
