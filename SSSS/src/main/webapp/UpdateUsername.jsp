...
<div class="header">
    ...
    <h2  style="margin-left: 105px;">ADD-BUILDING DETAILS </h2> <br><br>
        <label for="currentUsername" style="font-size: 16px;">Current Username:</label>
        <input class="funk" type="text" id="currentUsername" style="margin-left: 25px;"name="currentUsername" value="<%= session.getAttribute("username") %>" disabled>

        <label for="newUsername" style="font-size: 16px;">New Username:</label>
