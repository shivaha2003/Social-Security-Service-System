...
%>
    ...
    <form class="akhil" action="AddStaffDetailsServlet" method="POST">
        <h2 style="margin-left: 105px;">ADD-STAFF DETAILS</h2><br><br>
        <label for="StaffFullName" style="font-size: 16px;"><strong>&nbsp;&nbsp;&nbsp;Staff Full Name:</strong></label>
        <input type="text" class="funk" name="StaffFullName" style="margin-left: 50px;" placeholder="Enter Full Name" required><br><br>
        <label for="Role" style="font-size: 16px;"><strong>&nbsp;&nbsp;&nbsp;Role:</strong></label>
        <input type="text" class="funk" name="Role" style="margin-left: 120px;" placeholder="Enter Role" required><br><br>
        <label for="ContactPhone" style="font-size: 16px;"><strong>&nbsp;&nbsp;&nbsp;Contact Phone:</strong></label>
        <input type="text" class="funk" name="ContactPhone" style="margin-left: 50px;" placeholder="Enter Contact Phone" required><br><br>
