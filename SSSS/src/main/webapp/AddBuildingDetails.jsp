...
<div class="center-box">
    ...
    <form class="akhil"action="AddBuildingDetailsServlet" method="POST">
        
            <h2  style="margin-left: 105px;">ADD-BUILDING DETAILS </h2> <br><br>
           <label for="BuildingName" style="font-size: 16px;"><strong>&nbsp;&nbsp;&nbsp;BuildingName : </strong></label>
           <input type="text"class="funk" name="BuildingName" style="margin-left: 50px;" placeholder="Enter here" required> <br> <br>
           <label for="NumFlatsPerFloor" style="font-size: 16px;">&nbsp;&nbsp;&nbsp;<strong>NumFlatsPerFloor:</strong></label>
           <input type="number" class="funk" name="NumFlatsPerFloor" style="margin-left: 25px;"placeholder="Enter NoFlatsperFloor here" min='1' required> <br> <br>
            <label style="font-size: 16px;" for="Total_flats">&nbsp;&nbsp;&nbsp;Total Flats:</label>
            <input class="funk" type="number" style="margin-left: 80px;" name="Total_flats" placeholder="Enter Total_Flats here" min='1'required>
